...
//        e.g https://github.com/shantanudevlalikar/events-app-api-server.git might become https://github.com/MyName/external.git
// variables:
//      roidtc-may2022-u203
...
//      https://github.com/shantanudevlalikar/events-app-api-server.git
//      shantanudeolalikar
//      api-server-image
//      cluster-1 
...
//      demo-api
//       (name of the container to be replaced - in the template/spec section of the deployment)
...
pipeline {
   ...
   environment {
        ...
        imageName = 'shantanudeolalikar/api-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/shantanudevlalikar/events-app-api-server.git'
        ...
        stage('Building image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials cluster-1 --zone us-central1-c --project roidtc-may2022-u203'
            }
        }     
         stage('update k8s') {
             agent {
